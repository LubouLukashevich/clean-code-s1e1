...
//--delete--var incompleteTaskHolder=document.getElementById("incompleteTasks");//ul of #incompleteTasks
var incompleteTaskHolder=document.querySelector(".incompleteTasks");//ul of #incompleteTasks
//--delete--var completedTasksHolder=document.getElementById("completed-tasks");//completed-tasks
...
//select ListItems children
  ...
  //--delete--var editButton=taskListItem.querySelector("button.edit");
  var editButton=taskListItem.querySelector(".button-edit");
  //--delete--var deleteButton=taskListItem.querySelector("button.delete");
